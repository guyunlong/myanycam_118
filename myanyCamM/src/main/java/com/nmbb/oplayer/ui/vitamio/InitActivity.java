	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		new AsyncTask<Object, Object, Object>() {
			...
			protected Object doInBackground(Object... params) {
				...
				// Method extractLibs = c.getDeclaredMethod("extractLibs", new
				// Class[] { android.content.Context.class, int.class });
				// extractLibs.setAccessible(true);
				// extractLibs.invoke(c, new Object[] { getApplicationContext(),
				// R.raw.libarm });
				//
