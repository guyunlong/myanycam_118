...
public class XListView extends ListView implements OnScrollListener {
	...
	public void setPullRefreshEnable(boolean enable) {
		ELog.i(TAG, "setPullRefreshEnable..");
...
//		ELog.i(TAG, "computeScroll..");
	...
	public void setOnScrollListener(OnScrollListener l) {
		ELog.i(TAG, "setOnScrollListener..");
		mScrollListener = l;
	}

	@Override
	public void onScrollStateChanged(AbsListView view, int scrollState) {
//		ELog.i(TAG, "onScrollStateChanged..");
...
//		ELog.i(TAG, "onScroll..");
	...
	public void setXListViewListener(IXListViewListener l,int id) {
		ELog.i(TAG, "setXListViewListener..");
		mListViewListener = l;
		this.id = id;
	}
